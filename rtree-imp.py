...
def query_for_nearest_terms(idx,keyMap,queryKey,numOfNearest = 5, notincludeQuery = False):
    x = keyMap[queryKey]
    Y = dataDict[queryKey]
    histogram = {}
    for y in Y:
...
def main():
    ...
    for keys in dataDict:
        print keys
        nearestTermsHistogram = query_for_nearest_terms(idx,keyMap,keys,numOfNearest=3)
        print nearestTermsHistogram
#        print "="*27
main()
print dataDict.keys()[23]
